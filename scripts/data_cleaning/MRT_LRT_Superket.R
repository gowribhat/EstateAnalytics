...
mrt <- fromJSON("./data/raw/LTAMRTStationExitGEOJSON.geojson")
...
saveRDS(mrt, "./data/clean/LRT_MRT.rds")

mart <- fromJSON("./data/raw/SupermarketsGEOJSON.geojson")
...
saveRDS(mart, "./data/clean/Supermarkets.rds")
