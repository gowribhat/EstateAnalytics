...
ui <- fluidPage(
  ...
  div(
    ...
    # Container for the analytics dashboard content - using conditionalPanel to properly manage content visibility
    div(
      id = "analytics_dashboard_container",
      style = "height: calc(100% - 50px);",
      
      # Loading UI - shown by default, hidden when analytics dashboard is ready
      conditionalPanel(
